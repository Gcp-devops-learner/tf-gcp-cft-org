...
variable "parent_folder" {
  description = "Name of pared folder"
  type        = string
  default     = ""
}
variable "parent_id" {
  description = "Name of pared id"
  type        = string
  default     = ""
}
...
variable "bootstrap_folder_name" {
  description = "Provide the bootstrap_folder_name"
  type        = string
}

variable "networks_step_terraform_service_account_email" {
  description = "Provide the networks_step_terraform_service_account_email"
  type        = string
}
